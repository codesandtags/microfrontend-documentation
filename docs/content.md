...
- [Module Federation vs Single SPA](https://blog.bitsrc.io/module-federation-vs-single-spa-47da53b67ed0)
- [Micro Frontend Driver for Scalability](https://dev.to/florianrappl/micro-frontend-discovery-the-driver-for-scalability-oai)
- [Custom Elements Everywhere](https://custom-elements-everywhere.com/) Making sure frameworks and custom elements can be BFFs

## Videos and talks


- [Talk: Micro Frontends - MicroCPH, Copenhagen 2019 (Slides)](https://www.youtube.com/watch?v=wCHYILvM7kU)
